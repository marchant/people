    ...
    */
    ...
    _shouldPreventDefault: {
        value: function(event) {
            return !!event.target.tagName && TranslateComposer.prototype._NATIVE_ELEMENTS.indexOf(event.target.tagName) === -1 && !event.target.isContentEditable;
        }
    },

	_ObservedPointerMouse: {
		value:"mouse"
	},
    /**
    ...
    handleMousedown: {
        value: function(event) {
            this._observedPointer = this._ObservedPointerMouse;
...
TranslateComposer.prototype.captureMousewheel = TranslateComposer.prototype.captureWheel;
 ...
 //# sourceURL=http://127.0.0.1.xip.io:8081/people/node_modules/montage/composer/translate-composer.js
