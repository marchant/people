...
*/
    _fitPointerCurve: {
        enumerable: false,
        value: function (bezier, data, length) {
            var pos, a, b, c, d, epsilon = 0.0001,
                dl = length, e, t, v, t2, t3, i,
...
_calculatePointerVelocityArrayBuffer: {
	value:[]
},
_calculatePointerVelocityBezier: {
	value:[]
},
/**
  @private
*/
    _calculatePointerVelocity: {
        enumerable: false,
        value: function _calculatePointerVelocity(time, position) {
            ...
            if (timeInterval) {
                if (length > 5) {
                    var s, e, bezier = this._calculatePointerVelocityBezier, data = this._calculatePointerVelocityArrayBuffer, iData;
                    for (i = 0; i < length; i++) {
						(iData = data[i] || (data[i] = {})).v = position[i];
                        iData.t = (time[i] - timeMin) / timeInterval;
                    }
                    s = data[iMin].v;
                    e = data[0].v;
                    ...
                    this._fitPointerCurve(bezier, data,length);
    ...
    pointerMotion: {
        value: function (identifier) {
            if (defaultEventManager._pointerStorage.isStored(identifier)) {
                return defaultEventManager._pointerStorage.pointerVelocity(identifier);
            } else {
                return undefined;
            }
        }
