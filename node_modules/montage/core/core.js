    ...
    value: function specialize(prototypeProperties, constructorProperties) {
        ...
        if (CONSTRUCTOR_COMPATIBILITY) {
            ...
            constructorProperty = function(original, constructor, propertyName) {
 				//console.log("##### constructorProperty ("+propertyName+")");
               function deprecationWrapper() {
					console.log("deprecationWrapper for "+propertyName);
                    if(this === constructor) {
            ...
            for (propertyName in prototypeProperties) {
                if(FUNCTION_PROPERTIES.has(propertyName)) {
                    // illegal properties on function
 					console.log("##### "+propertyName+": illegal properties on function");
...
var uuidGetGenerator = function() {
    ...
    try {
        if (info !== null && info.isInstance === false) {
            this._uuid = uuid;
            Object.defineProperty(this, UUID_CONSTANT, {
                get: function() {
                    if (this.hasOwnProperty(UUID_CONSTANT)) {
            ...
            if (this instanceof Element || !info.isInstance || !(VALUE in (Object.getOwnPropertyDescriptor(this, UUID_CONSTANT)||{})) || !(PROTO in this /* lame way to detect IE */)) {
                //This is needed to workaround some bugs in Safari where re-defining uuid doesn't work for DOMWindow.
                this._uuid = uuid;
            }
        }
...
/**
    ...
    @default null
*/
Object.defineProperty(Object.prototype, UUID_CONSTANT, {
    configurable: true,
    get: defaultUuidGet,
    set: function() {
    }
...
Montage.defineProperty(Montage.prototype, "isDeserializing", {value: false});
