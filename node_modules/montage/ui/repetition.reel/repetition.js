...
var Repetition = exports.Repetition = Component.specialize(/** @lends Repetition# */{
    ...
    _ignoreSelectionPointer: {
        value: function () {
			...
			/* #PERFORMANCE CONCERN
				Scrolling the flows does this repeatedly which is generating a lot of garbage. We also do all input types on devices for which it doesn't make sense,
				like tracking mouse on an iOS device so far.
				I don't know if we could change the logic here, or do something in EventManager/
				Would be good to keep better track of things here, like the active iterations, that could help be smarter/fine grained about the event listeners.
			*/
            var document = this.element.ownerDocument;
