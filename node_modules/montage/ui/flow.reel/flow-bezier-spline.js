...
var FlowBezierSpline = exports.FlowBezierSpline = Montage.specialize( {
    ...
    getPositionAtIndexTime: {
        value: function (indexTime, scale, pos) {
            ...
            if (scale) {
                    ...
                    pos[0] = (scale.x.numerator * (p0[0] * coef1 + p1[0] * coef2 + p2[0] * coef3 + p3[0] * coef4)) / scale.x.denominator;
                    pos[1] = (scale.y.numerator * (p0[1] * coef1 + p1[1] * coef2 + p2[1] * coef3 + p3[1] * coef4)) / scale.y.denominator;
                    pos[2] = (scale.z.numerator * (p0[2] * coef1 + p1[2] * coef2 + p2[2] * coef3 + p3[2] * coef4)) / scale.z.denominator;
				return pos;
            } else {
                    pos[0] = p0[0] * coef1 + p1[0] * coef2 + p2[0] * coef3 + p3[0] * coef4,
                    pos[1] = p0[1] * coef1 + p1[1] * coef2 + p2[1] * coef3 + p3[1] * coef4,
                    pos[2] = p0[2] * coef1 + p1[2] * coef2 + p2[2] * coef3 + p3[2] * coef4
 				return pos;
          }
        }
    },
    ...
    getRotationAtIndexTime: {
        value: function (indexTime, rotation) {
            var index = indexTime[0],
                time = indexTime[1],
                rotateX,
                rotateY,
