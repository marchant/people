...
var FlowTranslateComposer = exports.FlowTranslateComposer = TranslateComposer.specialize( /** @lends FlowTranslateComposer# */ {
     ...
     */
    _analyzeMovement: {
        value: function FlowTranslateComposer_analyzeMovement(event) {
    ...
    _dispatchTranslateStart: {
        value: function FlowTranslateComposer_dispatchTranslateStart(x, y) {
    ...
    _dispatchTranslateEnd: {
        value: function FlowTranslateComposer_dispatchTranslateEnd() {
    ...
    _dispatchTranslateCancel: {
        value: function FlowTranslateComposer_dispatchTranslateCancel() {
    ...
    _computePointedElement: {
        value: function _computePointedElement() {
            ...
            if (pathsLength) {
                ...
                for (i = 0; i < length; i++) {
                    offset = this._flow.offset(visibleIndexes[i],offset);
     ...
     */
    _animationInterval: {
        value: function _animationInterval() {
