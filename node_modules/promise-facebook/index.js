...
//                });
    ...
    // album
    //
    facebook.feed = function (user) {
        return facebook.api(feedEdge(user), GET).get("data");
    };
    facebook.photo = function (id) {
        return facebook.api(photoEdge(id), GET);
    };
    facebook.photoImages = function (id) {
        return facebook.photo(id).get("images");
    };
    ...
    facebook.me = function () {
        return facebook.api(meEdge(), GET);
    };
    facebook.myFriends = function () {
        return facebook.api(myFriendsEdge(), GET).get("data");
    };
    facebook.myFeed = function () {
        return facebook.api(myFeedEdge(), GET).get("data");
    };
    //
    // comments
    //
    facebook.comments = function (object) {
        return facebook.api(commentsEdge(object), GET).get("data");
    };
    facebook.likes = function (object) {
        return facebook.api(likesEdge(object), GET).get("data");
    };
...
var friendEdge = function (friend1, friend2) {
    return idEdge(friend1.id) + "/friends/" + friend2.id;
}
var myFriendsEdge = function () {
    return meEdge() + "/friends";
}
var myFeedEdge = function () {
    return meEdge() + "/feed";
}
var feedEdge = function (user) {
    return idEdge(user.id) + "/feed";
}
...
var commentsEdge = function (object) {
    return idEdge(object.id) + "/comments";
}
var likesEdge = function (object) {
    return idEdge(object.id) + "/likes";
}
var photoEdge = function (id) {
    return idEdge(id);
}
